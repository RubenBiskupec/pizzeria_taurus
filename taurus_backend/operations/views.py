...
def create_order(request):
    ...
    custom_pizzas = request.data["custom_pizzas"]
    half_meter_pizzas = request.data["half_meter_pizzas"]
    beverages = request.data["beverages"]
...
def review_details(request, pk=None):
    ...
    pprint(vars(order_instance))
    # review.order_id = order_instance.id
    pprint(vars(review))
    # Review.order = order_instance
